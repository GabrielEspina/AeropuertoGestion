...
public class PanelFichaBotonesAeropuerto extends JPanel{
	...
	public void onClickBtnAgregar(ActionEvent arg0) {
		getAeropuertos().add( new Aeropuerto( getPanelCampos().getTxtIdAeropuerto().getText(), getPanelCampos().getTxtNombre().getText() ) );
		getPanelLista().refrescar();		
	}
	
	
	public void onClickBtnBorrar(ActionEvent arg0) {
		getAeropuertos().delete( new Aeropuerto( getPanelCampos().getTxtIdAeropuerto().getText(), getPanelCampos().getTxtNombre().getText() ) );
		getPanelLista().refrescar();		
